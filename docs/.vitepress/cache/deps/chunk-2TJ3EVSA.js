  ...
  const res = customRef((track2, trigger2) => {
    ...
    return {
      ...
      set(value) {
        ...
        (name in rawProps || camelizedName in rawProps) && (`onUpdate:${name}` in rawProps || `onUpdate:${camelizedName}` in rawProps)) && hasChanged2(value, localValue)) {
          localValue = value;
          trigger2();
        }
...
function propHasMismatch(el, key, clientValue) {
  ...
  if (key === "class") {
    ...
    expected = isBooleanAttr2(key) ? includeBooleanAttr(clientValue) ? "" : false : clientValue == null ? false : String(clientValue);
    if (actual !== expected) {
...
@vue/runtime-dom/dist/runtime-dom.esm-bundler.js:
  (*! #__NO_SIDE_EFFECTS__ *)
*/
//# sourceMappingURL=chunk-2TJ3EVSA.js.map
